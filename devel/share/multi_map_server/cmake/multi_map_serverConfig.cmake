...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/wjh/sim_env202502011611/src/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/wjh/sim_env202502011611/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /home/wjh/sim_env202502011611/install)
...
if(NOT "/home/wjh/sim_env202502011611/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wjh/sim_env202502011611/src/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
