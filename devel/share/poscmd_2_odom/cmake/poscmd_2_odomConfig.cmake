...
if("TRUE" STREQUAL "TRUE")
  set(poscmd_2_odom_SOURCE_PREFIX /home/wjh/sim_env202502011611/src/uav_simulator/fake_drone)
  set(poscmd_2_odom_DEVEL_PREFIX /home/wjh/sim_env202502011611/devel)
  ...
  set(poscmd_2_odom_INSTALL_PREFIX /home/wjh/sim_env202502011611/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'poscmd_2_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wjh/sim_env202502011611/src/uav_simulator/fake_drone/${idir}'.  ${_report}")
    endif()
